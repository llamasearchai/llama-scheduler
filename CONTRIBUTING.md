# Contributing to Llama Scheduler

Thank you for your interest in contributing to Llama Scheduler! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Scheduler:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-scheduler.git
   cd llama-scheduler
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-scheduler.git
   ```
...
By contributing to Llama Scheduler, you agree that your contributions will be licensed under the project's MIT License.
