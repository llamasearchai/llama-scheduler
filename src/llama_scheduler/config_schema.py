...
class JobStore(BaseModel):
    ...
    url: Optional[str] = Field(
        None, description="Connection URL for database-based jobstores"
    )
...
class Executor(BaseModel):
    ...
    type: str = Field(
        ..., description="Executor type (e.g., 'threadpool', 'processpool')"
    )
...
class JobDefinition(BaseModel):
    ...
    max_instances: Optional[int] = Field(
        None, description="Maximum concurrent instances"
    )
    next_run_time: Optional[datetime] = Field(
        None, description="Next scheduled run time"
    )
    executor: Optional[str] = Field(
        "default", description="Executor to use for this job"
    )
    jobstore: Optional[str] = Field(
        "default", description="Job store to store this job"
    )
    ...
    minutes: Optional[int] = Field(
        None, description="Number of minutes between executions"
    )
    seconds: Optional[int] = Field(
        None, description="Number of seconds between executions"
    )
    ...
    year: Optional[Union[str, int]] = Field(
        None, description="Year field for cron trigger"
    )
    month: Optional[Union[str, int]] = Field(
        None, description="Month field for cron trigger"
    )
    day: Optional[Union[str, int]] = Field(
        None, description="Day field for cron trigger"
    )
    week: Optional[Union[str, int]] = Field(
        None, description="Week field for cron trigger"
    )
    ...
    hour: Optional[Union[str, int]] = Field(
        None, description="Hour field for cron trigger"
    )
    minute: Optional[Union[str, int]] = Field(
        None, description="Minute field for cron trigger"
    )
    second: Optional[Union[str, int]] = Field(
        None, description="Second field for cron trigger"
    )
